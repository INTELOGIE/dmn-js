...
describe('features/descriptions', function() {
  ...
  it('#canEdit', inject(function(descriptionsEditing) {

    // then
    expect(descriptionsEditing.canEdit('hello \n')).to.be.true;
    expect(descriptionsEditing.canEdit('hello there')).to.be.true;
    expect(descriptionsEditing.canEdit('hello \n there')).to.be.true;
    expect(descriptionsEditing.canEdit('')).to.be.true;

    expect(descriptionsEditing.canEdit('\n')).to.be.false;
    expect(descriptionsEditing.canEdit('\r')).to.be.false;

    expect(descriptionsEditing.canEdit('\r blah')).to.be.true;
  }));
